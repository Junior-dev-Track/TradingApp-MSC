    ...
    return (
        <div className="portfolio-summary max-w-7xl w-px-50 mx-auto sm:px-6 lg:px-8 text-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div className="flex space-x-4 text-white">
                <div className="ml-1 p-4 border border-gray-300 bg-gray-50 rounded-lg mb-4 bg-darker-blue">
                    <p>Total Balance: ${totalBalance.toLocaleString()}</p>
                </div>
                <div className="p-4 border border-gray-300 bg-gray-50 rounded-lg mb-4 bg-darker-blue">
